...
//       produit.type.type.toLowerCase().includes(searchQuery.toLowerCase()) ||
//       produit.stock.toString().includes(searchQuery) ||
//       produit.incoming_quantity.toString().includes(searchQuery) || // Add search for incoming quantity
//       produit.outgoing_quantity.toString().includes(searchQuery) || // Add search for outgoing quantity
//       produit.initial_quantity.toString().includes(searchQuery) || // Add search for initial quantity
//       produit.created_at.includes(searchQuery))
//   );
...
//                         )}
//                       </th>
//                       <th className='px-3 py-3 cursor-pointer' onClick={() => handleSort('incoming_quantity')}>
//                         Quantité Entrante
//                         {sortConfig.key === 'incoming_quantity' && (
//                           <FontAwesomeIcon icon={sortConfig.direction === 'ascending' ? faSortUp : faSortDown} />
//                         )}
//                       </th>
//                       <th className='px-3 py-3 cursor-pointer' onClick={() => handleSort('outgoing_quantity')}>
//                         Quantité Sortante
//                         {sortConfig.key === 'outgoing_quantity' && (
//                           <FontAwesomeIcon icon={sortConfig.direction === 'ascending' ? faSortUp : faSortDown} />
//                         )}
//                       </th>
//                       <th className='px-3 py-3 cursor-pointer' onClick={() => handleSort('initial_quantity')}>
//                         Quantité Initiale
//                         {sortConfig.key === 'initial_quantity' && (
//                           <FontAwesomeIcon icon={sortConfig.direction === 'ascending' ? faSortUp : faSortDown} />
//                         )}
//                       </th>
//                       <th className='px-3 py-3 cursor-pointer' onClick={() => handleSort('created_at')}>
...
//                         <td className='px-3 py-2'>{produit.type.type}</td>
//                         <td className='px-3 py-2'>{produit.stock}</td>
//                         <td className='px-3 py-2'>{produit.incoming_quantity}</td>
//                         <td className='px-3 py-2'>{produit.outgoing_quantity}</td>
//                         <td className='px-3 py-2'>{produit.initial_quantity}</td>
//                         <td className='px-3 py-2'>{produit.created_at}</td>
//                         <td className='px-3 py-2 text-right flex justify-end'>
//                           <button
//                             onClick={() => openModal('edit', produit)}
