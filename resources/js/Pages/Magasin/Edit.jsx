...
export default function Create({auth , magasin}){
    const{data , setData , post, errors , reset} = useForm({
        'nomMagasin': magasin.NomM  || '',
    })
    const onSubmit = (e)=> {
        e.preventDefault();
        post(route('magasin.update',magasin.id));
    }
    return (
        <AuthenticatedLayout
        // user={auth.user}
    ...
    <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div className="p-6 text-gray-900 dark:text-gray-100">
                <div className="p-6 text-gray y-900 dark:text-gray-100">Npm du magasin</div>
