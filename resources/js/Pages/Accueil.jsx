      ...
      <div className="p-6 lg:flex">
        <div className="lg:flex lg:flex-wrap lg:-mx-4">
          {Object.entries(percentages || {}).map(([key, item], index) => (
            <div
              key={index}
              className="bg-white p-5 border border-gray-200 rounded-xl shadow-md lg:w-1/2 lg:mx-2 mb-6"
              style={{ height: '300px', width: '300px' }} // Adjusted height
            >
              <div className="text-lg font-semibold mb-4">{key}</div>
              <div className="flex justify-around items-center">
                <div className="text-center">
                  <CircleProgress percentage={item.validated} color="green" />
                  <div className="text-sm text-gray-500 mt-2">Validé</div>
                </div>
                <div className="text-center">
                  <CircleProgress percentage={item.nonValidated} color="red" />
                  <div className="text-sm text-gray-500 mt-2">Non Validé</div>
                </div>
              </div>
            </div>
          ))}
